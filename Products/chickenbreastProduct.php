...
if (isset($_POST['insert']))
{
    ...
    $pimage = 'Images/chicken-breast.jpg';
...
<!--   <ul class="aisleList">
      ...
      <form method = "POST" action = "chickenbreastProduct.php"> 
        <div class="product-border">
            <img class="images" name = "p-img" src="../Images/chicken-breast.jpg"
            alt="Image of chicken breast">
            <div class="display">
                <h3 class="product-name-chicken" name = "p-name">Chicken Breast</h3>
                <div class="moredescription_contain">
                <p class="product-description">2 breasts (approx. 400g)<span id="dots">...</span><span id="more">. Each package contains 2 chicken breasts. It is lean cut of meat taken from the pectoral muscle on the underside of the chicken. Highest quality in the market!</span></p> </div>
                <span class="product-price" name = "p-price"> $9.00</span>
