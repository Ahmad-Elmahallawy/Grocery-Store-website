...
<!--   <ul class="aisleList">
      ...
      <form method = "POST" action = "orangeProduct.php">
        <div class="product-border">
            <img class="images" name = "p-img" src="../Images/orange.jpg"
            alt="Image of orange">
            <div class="display">
                <h3 class="product-name-orange" name = "p-name">Orange</h3>
              <div class="moredescription_contain">
                <p class="product-description">1 bag (approx.                   1.3kg)<span id="dots">...</span><span                          id="more">. Fresh Orange that is easy to peel                  and cut. Each orange is approximately 150                      grams. From poEATry farms!</span></p>
              </div>
                <span class="product-price" name = "p-price"> $5.99</span>
