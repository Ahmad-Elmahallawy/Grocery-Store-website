...
if (isset($_POST['insert']))
{
    ...
    #$purl = 'https://poeatry-php-version.clarag1.repl.co/Products/spaghettiProduct.php';
    $pimage = 'Images/apple.jpg';
    $pname = 'Apple';
    ...
    $infoTag = $xml->createElement("info");
        #$urlTage = $xml->createElement("url", $purl);
...
<div class="row menu h-100 col-12 nopadding sticky-top">
    ...
    <form method = "POST" action = "appleProduct.php">
        <div class="product-border">
            <img class="images" name = "p-img" src="../Images/apple.jpg" alt="Image of apple">
            <div class="display">
                <h3 class="product-name" name = "p-name">Apple</h3>
              <div class="moredescription_contain">
                <p class="product-description">1 bag (approx. 2kg)<span id="dots">...</span><span id="more">. Each apple weighs around 200 g. Red fresh apples coming from the Canadian farms. 
                    100% natural with the highest quality!</span></p> </div>
                <span class="product-price" name = "p-price"> $7.99</span>
