...
<!--   <ul class="aisleList">
     ...
     -->
      <form method = "POST" action = "rotiniProduct.php">
        <div class="product-border">
            <img class="images" name = "p-img" src="../Images/rotini.jpg"
            alt="Image of rotini">
            <div class="display">
                <h3 class="product-name" name = "p-name">Rotini</h3>
              <div class="moredescription_contain">
                <p class="product-description">1 pack (approx. 410g)<span id="dots">...</span><span id="more">. Rotini pasta is low in fat and cholestrol free! It is also a source for 5 essential nutrients and fibre. Never sticky, never starchy, the perfect pasta you will find. </span></p>
              </div>
                <span class="product-price" name = "p-price"> $3.19</span>
