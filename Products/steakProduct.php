...
<head>
  ...
  <script src="../MoreDescription.js"></script>
...
<!--   <ul class="aisleList">
      ...
      <form method = "POST" action = "steakProduct.php">
        <div class="product-border">
            <img class="images" name = "p-img" src="../Images/steak.jpg"
            alt="Image of steak">
            <div class="display">
                <h3 class="product-name" name = "p-name">Steak</h3>
              <div class="moredescription_contain">
                <p class="product-description ">1 steak (approx. 300g)<span id="dots">...</span><span id="more">. A steak is a                    meat generally sliced across the muscle fibres. Each                      piece of steak costs $16. They are to be frozen if not                     cooked directly</span></p></div>
                <span class="product-price" name = "p-price"> $16.00</span>
