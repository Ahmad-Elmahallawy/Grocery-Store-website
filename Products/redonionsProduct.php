...
<!--   <ul class="aisleList">
      ...
      <form method = "POST" action = "redonionsProduct.php">
        <div class="product-border">
            <img class="images" name = "p-img" src="../Images/red-onions.jpg"
            alt="Image of red onions">
            <div class="display">
                <h3 class="product-name-onions" name = "p-name">Red                       Onions</h3>
              <div class="moredescription_contain">
                <p class="product-description">1                          vegetable (approx. 330g)<span id="dots">...</span><span id="more">. Red onions are ordered by piece. Coming from poEATry farms, we sell the highest quality onions. Available in large quantities!</span></p></div>
                <span class="product-price" name = "p-price"> $1.65</span>
