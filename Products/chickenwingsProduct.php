...
if (isset($_POST['insert']))
{
    ...
    $pimage = 'Images/chicken-wings.jpg';
    $pname = 'Chicken Wings';
...
<div class="row menu h-100 col-12 nopadding sticky-top">
 ...
 <!--  <ul class="aisleList">
      ...
      <form method = "POST" action = "chickenwingsProduct.php">
        <div class="product-border">
            <img class="images" name = "p-img" src="../Images/chicken-wings.jpg" alt="Image of chicken wings">
            <div class="display">
                <h3 class="product-name-chicken" name = "p-name">Chicken Wings</h3>
              <div class="moredescription_contain">
                <p class="product-description">8 wings (approx. 500g)<span id="dots">...</span><span id="more">. Each package               
                includes 8 wings. They are divided into 4 drumettes and 4 wingettes. Rich in protein and low fats!</span></p>
              </div>
                <span class="product-price" name = "p-price"> $7.50</span>
