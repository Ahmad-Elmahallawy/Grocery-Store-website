...
<!--   <ul class="aisleList">
      ...
      <form method = "POST" action = "spaghettiProduct.php">
        <div class="product-border">
            <img class="images" name = "p-img" src="../Images/spaghetti.jpg"
            alt="Image of spaghetti">
            <div class="display">
                <h3 class="product-name-spaghetti" name = "p-name">Spaghetti</h3>
              <div class="moredescription_contain">
                <p class="product-description">1 pack (approx. 410g)<span id="dots">...</span><span id="more">. Spaghetti made with durum wheat. Low fat and cholestrol. Loved by all families in Canada. Easy and fast to cook.</p></div></span>
