...
{  
    ...
    $order->addChild('client', $_POST['client']);
    $order->addChild('shipadd', $_POST['shipadd']);
...
<div class="container-fluid">
  <div class="row">
    ...
    <form method="POST" action="P12Add.php">
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <div class="row">
        <div class="col">
          ...
          <input type="text" class="form-control"  aria-label="First name" name=id>
        </div>
      </div>
      <br>
      <div class="row">
        <div class="col">
          ...
          <input type="text" class="form-control"  aria-label="First name" name=client>
        </div>
      </div>
      <br>
      ...
      <div class="row">
        <div class="col">
          ...
          <input type="text" class="form-control"  aria-label="First name" name=shipadd>
        </div>
      </div>
      <br>
      <div class="row">
        <div class="col">
          ...
          <input type="text" class="form-control"  aria-label="First name" name=date>
        </div>
      </div>
      <br>
</form>
